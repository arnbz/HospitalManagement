...
public class SignUp extends Application {
    ...
    public void start(Stage stage) {
        ...
        //adding elements to {@code userTypeChoiceBox}
        ...
        addButton.setOnAction(e -> {
            ...
            String position = userTypeChoiceBox.getValue();
            ...
            if(usersService.add(usersModel)) {
        ...
        HBox h3 = new HBox(20, positionLabel, userTypeChoiceBox);
