...
public class DoctorService {
    ...
    public boolean add(DoctorModel patient) {
        ...
        try {
            ...
            sql += "values('" + patient.getId() + "','" + patient.getName() + "','" + patient.getGender() + "','" + patient.getAge() + "','" +
                    patient.getPhoneNo() + "','" + patient.getAddress() + "','" + patient.getDisease() + "','" +
                    patient.getAdmissionDate() + "','" + patient.getCabinNo() + "','" + patient.getPrescription() + "')";
